...
function playerMovement() {
  ...
  player1.speedX = 0;
  player1.speedY = 0;
  if (myGameArea.keys && myGameArea.keys[65]) {player1.speedX = -3;}
  if (myGameArea.keys && myGameArea.keys[68]) {player1.speedX = 3;}
  if (myGameArea.keys && myGameArea.keys[87] && player1.jump == true) {player1.speedY = -8;}
  player1.newPos();
  player1.update();
  ...
  player2.speedX = 0;
  player2.speedY = 0;
  if (myGameArea.keys && myGameArea.keys[37]) {player2.speedX = -3;}
  if (myGameArea.keys && myGameArea.keys[39]) {player2.speedX = 3;}
  if (myGameArea.keys && myGameArea.keys[38] && player2.jump == true) {player2.speedY = -8;}
  player2.newPos();
  player2.update();
